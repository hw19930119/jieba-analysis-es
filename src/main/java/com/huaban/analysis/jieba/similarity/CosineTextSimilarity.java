...
public class CosineTextSimilarity extends TextSimilarity {
     ...
     */
    @Override
    protected double scoreImpl(List<Word> words1, List<Word> words2, Map<Integer, Integer> weightMap) {
        //用词频来标注词的权重
        taggingWeightWithWordFrequency(words1, words2, weightMap);
        //构造权重快速搜索容器
    ...
    public static void main(String[] args) {
        String text1 = "涟水交警接警后，发现现场除了受害者李梅，身份证号为：500102198702014291,一块机动车号牌苏A F001U和苏AF001U少量玻璃碎片外，没有其他有价值的线索。";
        String text2 = "涟水交警接警后，发现一块机动车号牌苏A F001U和苏AF001U少量玻璃碎片外，没有其他有价值的线索。";
        String text3 = "我的身份证号500102198702014291，电话18600213245，固定电话023-87898765";
        TextSimilarity textSimilarity = new CosineTextSimilarity();
        // double score1pk1 = textSimilarity.similarScore(text1, text1);
        Map<Integer, Integer> weight1 = new HashMap<>();
        weight1.put(SegToken.ENTITY_CHEPAI, 10);
        double score1pk2 = textSimilarity.similarScore(text1, text2, weight1);

        Map<Integer, Integer> weights = new HashMap<>();
        weights.put(SegToken.ENTITY_SFZH, 10);
        double score1pk3 = textSimilarity.similarScore(text1, text3, weights);
